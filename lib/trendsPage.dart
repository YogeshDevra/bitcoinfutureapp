...
class _TrendsPageState extends State<TrendsPage> {
  ...
  Future<void> callGraphApi() async {
    ...
    var uri = '${api_config.URL}/Bitcoin/resources/getBitcoinGraph?type=$_type&name=$currencyName';
    if (await api_config.internetConnection()) {
      try {
          ...
          if (data['error'] == false) {
            setState(() {
              ...
              for (var element in bitcoinDataList) {
                ...
                coin = step3;
                count = count + 1;
                color = count % 2 == 0 ? const Color(0xffF13434) : const Color(
                    0xff00B84A);
              }
              ...
              isLoading = false;
                ...
                // apiConfig.toastMessage(message: "Application Under Maintenance");
                print(e);
              }
            });
          }
        ...
        // api_config.toastMessage(message: 'An error occurred while fetching data.');
        setState(() {
          isLoading = false;
        });
      }
                                        ...
                                        Container(
                                            ...
                                            child: Padding(
                                              ...
                                              child: FadeInImage(
                                                ...
                                                image: NetworkImage("${api_config.URL}/Bitcoin/resources/icons/${name.toLowerCase()}.png"),
                                              ),
                                            )
                                        ),
                                        const SizedBox(
